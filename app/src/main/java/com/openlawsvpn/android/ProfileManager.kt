 ...
 *
 * Storage layout:
 *   filesDir/profiles/<uuid>/config.ovpn   — filtered .ovpn content
 *   filesDir/profiles/<uuid>/meta.json     — name + createdAt
 *
 * Protected by the Android sandbox (mode 0700 on the app data dir).
 * TODO: add AES-256 encryption via Android Keystore for defence-in-depth.
 */
class ProfileManager(private val context: Context) {
     ...
     * @param ovpn   Raw .ovpn file content (will be stored as-is in private storage).
     */
