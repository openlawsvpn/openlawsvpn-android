...
class SamlCallbackServerTest {
    ...
    fun normalizeBase64_spaceConvertedToPlus() {
        ...
        // "AB CD" → "AB+CD" (5 chars) → padded to "AB+CD===" (8 chars, multiple of 4).
        val result = SamlCallbackServer.normalizeBase64("AB CD")
        assertTrue("should start with AB+CD", result.startsWith("AB+CD"))
